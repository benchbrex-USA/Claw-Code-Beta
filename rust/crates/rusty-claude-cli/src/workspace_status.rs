...
pub(super) struct StatusContext {
    ...
    pub(super) loaded_config_files: usize,
    pub(super) discovered_config_files: usize,
    pub(super) memory_file_count: usize,
    pub(super) project_root: Option<PathBuf>,
    pub(super) git_branch: Option<String>,
    pub(super) git_summary: GitWorkspaceSummary,
    pub(super) sandbox_status: runtime::SandboxStatus,
}
...
pub(super) struct StatusUsage {
    ...
    pub(super) turns: u32,
    pub(super) latest: TokenUsage,
    pub(super) cumulative: TokenUsage,
